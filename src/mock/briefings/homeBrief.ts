  ...
  briefing: [
    {
      id: 's1',
      platform: 'github',
      title: 'PR #182 approved',
      summary: '3 teammates approved your changes — ready to merge.',
      timestamp: '12m ago',
    },
    {
      id: 's2',
      platform: 'github',
      title: 'CI flake on main',
      summary: 'Nightly build failed once on auth tests, then passed on retry.',
      timestamp: '40m ago',
    },
    {
      id: 's3',
      platform: 'slack',
      title: 'Sarah in #marketing',
      summary: '"@clarke can we get your approval on the campaign copy?"',
      timestamp: '25m ago',
    },
    {
      id: 's4',
      ...
      summary: 'Empty-state direction is blocked until you make the call.',
      timestamp: '50m ago',
    },
    {
      id: 's5',
      ...
      summary: 'Design review moved to 1:00 PM — 4 attendees updated.',
      timestamp: '30m ago',
    },
    {
      id: 's6',
      ...
      summary: '2 new tasks added under Launch and assigned to you.',
      timestamp: '45m ago',
    },
  ],
};
